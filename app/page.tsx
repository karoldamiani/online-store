...
export default function Home() {
  return (
    ...
    <Navbar />    
    <div className="relative overflow-hidden bg-white min-h-[calc(100vh-64px)] ">
      <div className="pt-16 pb-32 sm:pt-24 sm:pb-24 lg:pt-40 lg:pb-40">
            ...
            <div className="mt-10">
              ...
              >
                <div className="absolute transform sm:top-0 sm:left-1/2 sm:translate-x-8 lg:top-1/2 lg:left-1/2 lg:translate-x-8 lg:-translate-y-1/2">
                  <div className="relative flex items-center space-x-6 lg:space-x-8">
